...
- (id)initWithResourcePath:(NSString*)resourcePath objectManager:(RKObjectManager*)objectManager delegate:(id<RKObjectLoaderDelegate>)delegate {
	if ((self = [super initWithURL:[objectManager.client URLForResourcePath:resourcePath]])) {		
        _objectManager = objectManager;
        self.delegate = delegate;
        self.mappingQueue = objectManager.mappingQueue;
        self.mappingProvider = objectManager.mappingProvider;
...
- (id)init {
    ...
    if (self) {
        ...
        self.mappingProvider = [RKObjectMappingProvider mappingProvider];
    }
